class Rutas {
    ...
    procesarKMLPorRuta(kmlText, nombreRuta) {
    ...
    mostrarRutaEnMapa(folder, nombreRuta) {
    ...
    cargarSVGRuta(contenedorRuta, archivoSVG) {
